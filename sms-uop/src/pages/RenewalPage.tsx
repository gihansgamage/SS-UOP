...
const RenewalPage: React.FC = () => {
  ...
  // FIX: Pass ALL societies so inactive ones can also renew. Sort them A-Z.
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 1:
        return (
            <SocietyInfoStep
                ...
                onPrev={prevStep}
                isRenewal={true}
                // FIX: Pass the full list (mapped to 'activeSocieties' prop name to match component)
      ...
      case 4:
        return <ReviewStep formData={formData} onSubmit={handleSubmit} onPrev={prevStep} isRenewal={true} />;
      default:
        return null;
    }
  };
